 ...
 * 
 * @see https://github.com/OAI/OpenAPI-Specification/blob/master/versions/3.0.2.md#patterned-fields-1
 * */
export enum HttpStatus {
  ...
  /** The request entity has a media   which the server or resource does not support. For example, the client uploads an image as image/svg+xml, but the server requires that images use a different format.  */
  ...
  /** All 100-level response codes */
  '1XX' = '1XX',

  /** All 200-level response codes */
  '2XX' = '2XX',

  /** All 300-level response codes */
  '3XX' = '3XX',

  /** All 400-level response codes */
  '4XX' = '4XX',

  /** All 500-level response codes */
  '5XX' = '5XX'
}