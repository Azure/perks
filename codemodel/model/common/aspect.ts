...
export interface Aspect<TLanguage extends Language = Language, TProtocol extends Protocol = Protocol> extends Metadata<TLanguage, TProtocol> {
...
export class Aspect<TLanguage extends Language = Language, TProtocol extends Protocol = Protocol> extends Initializer implements Aspect<TLanguage, TProtocol>{
